...
class Download(object):
    def __init__(self,logger):
        ...
        self.data_url = "http://data.cma.cn/data/search.html?dataCode=B.0011.0001"
        # 用来存储cookie
    ...
    def data_download(self, stationId, begintime, endtime,landId,countryId,comConfig1,comConfig2):
        req_header = {
        ...
        values = [('dateS', begintime), ('dateE', endtime), ('hidden_limit_timeRange', '1'),
                ('hidden_limit_timeRangeUnit', 'Day'), ('isRequiredHidden[]', 'dateS'), ('isRequiredHidden[]', 'dateE'),
                ('comConfig1[]', comConfig1),('isRequiredHidden[]','comConfig1[]'),('chooseType','Station'),
                ('isRequiredHidden[]', 'station_ids[]'), ('continentCode',landId),('countryCode',countryId),
                ('station_ids[]', stationId), ('station_maps',''),
                ('comConfig2[]',comConfig2[0]),('comConfig2[]',comConfig2[1]),('comConfig22[]',comConfig2[2]),('comConfig2[]',comConfig2[3]),
                  ('comConfig2[]', comConfig2[4]), ('comConfig2[]', comConfig2[5]), ('comConfig2[]', comConfig2[6]),
                  ('comConfig2[]', comConfig2[7]),('comConfig2[]',comConfig2[8]),('comConfig2[]',comConfig2[9]),('comConfig2[]',comConfig2[10]),
                ('select','on'),('elements[]', 'V03099'),('elements[]', 'Time_Dev_WQ'), ('elements[]', 'Lat_Dev'),
                ('elements[]', 'Lon_Dev'),('elements[]', 'PRS_HWC'), ('elements[]', 'GPH'),('elements[]', 'WIN_D'),
                ('elements[]', 'WIN_S'), ('elements[]', 'TEM'), ('elements[]', 'DPT'), ('elements[]', 'DTD'),
                ('isRequiredHidden[]', 'elements[]'), ('dataCode', 'B.0011.0001'),('dataCodeInit', 'B.0011.0001'),
                  ('show_value','normal')]
